  ...
  return (
    <div className="flex flex-col h-[500px] border rounded-lg overflow-hidden">
         ...
         <div className="space-y-4">
          {messages.length === 0 && !disabled && (
             <div className="text-center text-muted-foreground p-4">
               Ask questions about the uploaded project file. For example: "What are the key milestones?" or "Identify potential risks."
             </div>
           )}
           {disabled && messages.length === 0 && (
             <div className="text-center text-muted-foreground p-4">
                Please select an industry and upload a file to start the chat.
             </div>
           )}
      ...
      <div className="flex items-center p-4 border-t bg-background">
        <Input
          type="text"
          placeholder={disabled ? "Select industry and upload file first..." : "Ask about your project..."}
          value={input}
